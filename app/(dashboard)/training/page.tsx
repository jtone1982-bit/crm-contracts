    ...
    switch (item.type) {
      ...
      case 'tip':
        return (
          <div key={idx} className="p-4 rounded-xl bg-white border border-[#e5ddd2]">
            {item.title && (
              <p className="text-sm font-semibold text-[#2d2520] mb-3 text-balance">{item.title}</p>
            )}
      ...
      default:
        return (
          <div key={idx} className="p-4 rounded-xl bg-white border border-[#e5ddd2]">
            {item.title && <p className="font-semibold text-[#2d2520] mb-2 text-balance">{item.title}</p>}
